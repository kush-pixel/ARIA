...
| Epic or Cerner sandbox access takes 2–4 weeks to provision | Medium | Medium | Sandbox application submitted in Week 1; synthetic FHIR bundles cover all development in the interim so no sprint is blocked. If expedited access is available, additional fees of approximately $200–$500 may be required. |
| Apple App Store requires IRB documentation or a legal review before approving the healthcare app | Medium | Medium | All compliance documentation pre-drafted in Week 11 before submission. If Apple requests formal legal documentation, additional funding of approximately $300–$500 for a health tech legal consultation will be required. |
...
| Expo EAS Build free tier exhausted during Sprint 5 | Medium | Low | Monitor build count weekly during Weeks 12–13. If the free limit is hit, additional funding of approximately $99 will be required for one month of the Expo Production plan. |
