...
TOOL_SCHEMAS: list[dict[str, Any]] = [
    ...
    },
    {
        ...
        "description": (
            ...
            "Use when asked about medication changes, current regimen, when a drug was started or stopped, "
            "or why a specific medication was prescribed — pair with get_clinical_context to correlate "
            "active problems with each drug and infer clinical indication."
        ),
        "input_schema": {
            "type": "object",
            "properties": {},
    ...
    },
    {
        ...
        "description": (
            ...
            "allergies, clinical background, or to infer why a medication was prescribed — "
            "active problems reveal the clinical indication for each drug in the regimen."
        ),
        "input_schema": {
            "type": "object",
            "properties": {},
    ...
    },
    {
        ...
        "description": (
            ...
            "Returns trend summary, medication status, adherence summary, visit agenda, and risk score. "
            "Use when asked for an overview, ARIA's assessment, the visit agenda, or a pre-visit summary."
        ),
        "input_schema": {
            "type": "object",
            "properties": {},
